...
export const GAMES: GameDef[] = [
  // ── Classic ──────────────────────────────────────────────────────────────────
  { id: 'tictactoe',    emoji: '🦊', title: 'FoxyTac',         description: 'Classic Tic-Tac-Toe with AI & online play', players: '1–2', tags: ['classic','ai','online'], color: '#818cf8', hot: true },
  ...
  { id: 'pong',         emoji: '🏓', title: 'Pong',            description: 'The original paddle battle',                 players: '1–2', tags: ['classic','local'],     color: '#38bdf8' },
  ...
  { id: 'chess',        emoji: '♟️', title: 'Chess',           description: 'Full chess with legal move validation',      players: '1–2', tags: ['classic','strategy','ai'], color: '#94a3b8', hot: true },
  { id: 'checkers',     emoji: '🔵', title: 'Checkers',        description: 'Classic draughts with AI opponent',         players: '1–2', tags: ['classic','ai'],        color: '#fb923c' },
  // ── Puzzle ───────────────────────────────────────────────────────────────────
  { id: 'sudoku',       emoji: '🔢', title: 'Sudoku',          description: 'Fill the grid — 3 difficulty levels',       players: '1',   tags: ['puzzle','logic'],      color: '#34d399', isNew: true },
  ...
  { id: 'hangman',      emoji: '🪢', title: 'Hangman',         description: 'Guess the word before time runs out',       players: '1',   tags: ['puzzle','word'],       color: '#f87171' },
  // ── Arcade ───────────────────────────────────────────────────────────────────
  ...
  // ── Card & Dice ──────────────────────────────────────────────────────────────
  { id: 'blackjack',    emoji: '🃏', title: 'Blackjack',       description: 'Beat the dealer to 21',                     players: '1',   tags: ['card','casino'],       color: '#fcd34d' },
  { id: 'yahtzee',      emoji: '🎲', title: 'Yahtzee',         description: 'Roll dice and score combos',                players: '1–4', tags: ['dice','strategy'],     color: '#f97316' },
  // ── Strategy ─────────────────────────────────────────────────────────────────
  { id: 'battleship',   emoji: '🚢', title: 'Battleship',      description: 'Sink the enemy fleet',                      players: '1–2', tags: ['strategy','classic'],  color: '#38bdf8', isNew: true },
  { id: 'reversi',      emoji: '⚫', title: 'Reversi',         description: 'Flip your opponent\'s discs',               players: '1–2', tags: ['strategy','ai'],       color: '#a78bfa' },
...
export const TAGS = ['all','hot','classic','arcade','puzzle','strategy','ai','word','card','memory','local'];
