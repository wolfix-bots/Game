...
export const GAMES: GameDef[] = [
  ...
  { id:'chess',       emoji:'♟️', title:'Chess',              description:'Full chess with legal moves, AI & promotion',   players:'1–2', tags:['classic','strategy','ai'],  color:'#94a3b8', hot:true },
  ...
  { id:'battleship',  emoji:'🚢', title:'Battleship',         description:'Place ships and sink the enemy fleet',          players:'1–2', tags:['strategy','ai'],            color:'#38bdf8' },
  { id:'rockpaper',   emoji:'✂️', title:'Rock Paper Scissors',description:'Best of rounds vs AI or a friend',              players:'1–2', tags:['classic','quick'],          color:'#34d399' },
  { id:'pong',        emoji:'🏓', title:'Pong',               description:'The original paddle battle',                    players:'1–2', tags:['classic','arcade'],         color:'#38bdf8' },

  // ── Dice / Board Games ───────────────────────────────────────────────────────
  { id:'snakeladdergame', emoji:'🎲', title:'Snake & Ladder', description:'Roll dice, climb ladders, avoid snakes!',       players:'2–4', tags:['board','dice','multiplayer'], color:'#f97316', hot:true, isNew:true },
  { id:'ludo',        emoji:'🎯', title:'Ludo',               description:'Race your tokens home before opponents',        players:'2–4', tags:['board','dice','multiplayer'], color:'#f59e0b', isNew:true },
  ...
  { id:'solitaire',   emoji:'🂠', title:'Solitaire',          description:'Classic Klondike solitaire card game',          players:'1',   tags:['card','classic'],           color:'#22c55e', isNew:true },
  ...
  { id:'sudoku',      emoji:'🔢', title:'Sudoku',             description:'Fill the grid — Easy, Medium, Hard',            players:'1',   tags:['puzzle','logic'],           color:'#34d399' },
  ...
  { id:'trivia',      emoji:'🧠', title:'Trivia Quiz',        description:'20 questions across science, history & more',   players:'1',   tags:['puzzle','word','quiz'],     color:'#818cf8', isNew:true },
  { id:'typeracer',   emoji:'⌨️', title:'Type Racer',         description:'Race against time — how fast can you type?',    players:'1',   tags:['arcade','skill'],           color:'#38bdf8', isNew:true },
  ...
  { id:'flappy',      emoji:'🐦', title:'Flappy Bird',        description:'Tap to fly through the pipes',                  players:'1',   tags:['arcade'],                   color:'#86efac' },
  ...
  { id:'whackamole',  emoji:'🔨', title:'Whack-a-Mole',      description:'Whack the moles as fast as you can',            players:'1',   tags:['arcade','action'],          color:'#a3e635' },

  // ── Memory / Reflex ──────────────────────────────────────────────────────────
  { id:'simon',       emoji:'🔴', title:'Simon Says',         description:'Repeat the colour sequence — how far can you go?', players:'1', tags:['memory','arcade'],         color:'#f472b6' },
];

export const TAGS = ['all','🔥 hot','classic','arcade','puzzle','strategy','board','ai','word','card','memory','dice','quiz','skill'];
