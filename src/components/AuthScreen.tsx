  ...
  return (
    <div style={{
      ...
      >
        ...
        <p style={{ color: t.textMuted, fontSize: '0.9rem', margin: '6px 0 0' }}>
          24 games · Sign in to save your progress
        </p>
      </motion.div>
      ...
      >
        ...
        <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
          ...
          {/* Username */}
          <div>
            <label style={{ color: t.textMuted, fontSize: '0.75rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em', display: 'block', marginBottom: '6px' }}>
              Username
            </label>
