...
import { User, Lock, Eye, EyeOff, LogIn, UserPlus, ChevronRight } from 'lucide-react';
...
export default function AuthScreen({ theme, onAuth, onGuest }: Props) {
    ...
    <div style={{
      ...
      >
        ...
        <h1 style={{ color: t.text, fontWeight: 900, fontSize: '2rem', margin: 0, letterSpacing: '-0.03em' }}>
          Foxy<span style={{ color: t.accent }}>Tac</span>
        </h1>
        <p style={{ color: t.textMuted, fontSize: '0.88rem', margin: '6px 0 0' }}>The ultimate Tic-Tac-Toe experience</p>
      </motion.div>
      ...
      >
        ...
        <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
            ...
            {tab === 'register' && (
              ...
              >
                <div style={{ marginBottom: '4px' }}>
                  <label style={{ color: t.textMuted, fontSize: '0.75rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Choose Avatar</label>
          ...
          <div>
            ...
            <div style={{ position: 'relative' }}>
              <User size={16} style={{ position: 'absolute', left: '12px', top: '50%', transform: 'translateY(-50%)', color: t.textMuted, pointerEvents: 'none' }} />
              <input
                ...
                required
                style={{
                  width: '100%', background: t.cellBg,
                  border: `2px solid ${t.border}`, borderRadius: '12px',
                  padding: '11px 12px 11px 36px', color: t.text,
            ...
            <div style={{ position: 'relative' }}>
              ...
              <input
                ...
                style={{
                  width: '100%', background: t.cellBg,
                  border: `2px solid ${t.border}`, borderRadius: '12px',
                  padding: '11px 40px 11px 36px', color: t.text,
                  fontSize: '0.95rem', outline: 'none',
                  transition: 'border-color 0.2s', boxSizing: 'border-box',
                }}
                onFocus={e => (e.target.style.borderColor = t.accent)}
            ...
            {error && (
              <motion.div
                ...
                style={{
                  ...
                  color: '#ef4444', fontSize: '0.83rem', fontWeight: 500,
                }}
              >{error}</motion.div>
            )}
          </AnimatePresence>
        ...
        <button onClick={onGuest}
          style={{
            ...
            border: `2px solid ${t.border}`, borderRadius: '14px',
            padding: '12px', cursor: 'pointer',
            color: t.textMuted, fontWeight: 700, fontSize: '0.9rem',
            display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px',
      ...
      <p style={{ color: t.textMuted, fontSize: '0.72rem', marginTop: '20px', textAlign: 'center', maxWidth: '300px' }}>
        Accounts are stored locally on your device. No data is sent to any server.
      </p>
    </div>
  );
}
